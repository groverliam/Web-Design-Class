...
<body>
	...
	<div id="content" >	
		...
		<?php 
			...
			$q = "SELECT * FROM users ORDER BY uname ASC LIMIT ". $start_from.", ". $display;
			...
			//echo "<td><a href='view_userstry3.php?page=".($page-1)."'>Last Page</a></td>";
		?>					
		</table>
		<?php
		echo "<a href='view_userstry3.php?page=".($page-1)."'>Previous Page | </a><a href='view_userstry3.php?page=".($page+1)."'>Next Page</a>";
		?>
		</center> 
	</div> <!--content -->
