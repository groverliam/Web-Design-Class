...
<?php
	if ($_SERVER['REQUEST_METHOD']=='POST'){		
		...
		if(!empty($error)){
			...
			$sql = "INSERT INTO user (uname, pword, fname, lname, email, llogin)
					VALUES ('$uname', '$pword', '$fname', '$lname', '$email', now())";
...
?>
	<div id = "container">
	<div class="header">
		<h1>Monmouth Auto Registration System</h1>
	</div>
		...
		<div class="column menu">
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						<td>Role: </td>
						<td><input type="radio" name="role" value = "staff">staff<br>
